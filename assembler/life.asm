...
goto 1 0 0 ``CELL_END
::CELL_CURRENTLY_DEAD
compare 2 1 0 3 $CURRENT_CELL_COUNTER
...
memcpy 3 0 0 $NEW_GRID_START $GRID_START 3200
goto 1 0 0 ``LIFE_ITER_START
::NOOP_LOOP
noop 0 0 0
goto 1 0 0 ``NOOP_LOOP
