...
def GRID_END 4010000
def RAND_BREAK 2147483647
#def RAND_BREAK 200000000
...
def H 2000008
def TMPVAL2 2000009
store 2 0 0 50 $DRAW_X
store 2 0 0 50 $DRAW_Y
store 2 0 0 100 $W 
store 2 0 0 100 $H
...
compare 2 1 0 $TMPVAL $ALL_WHITE
...
memcpy 3 0 0 $NEW_GRID_START $GRID_START 10000
