...
branch 2 0 0 3 ``BIOS_FUNC_0_PRINT_STR
compare 2 1 0 $BIOS_ARG0 1
branch 2 0 0 3 ``BIOS_FUNC_1_PRINT_STR_PACKED
::DISPATCHER_RETURN
return 0 0 0
#
#
...
::BIOS_FUNC_1_LOOP
    ...
    ::BIOS_FUNC_1_CHAR_LOOP
        ...
        branch 2 0 0 3 ``BIOS_FUNC_1_CHAR_LOOP_EXIT
    ...
    branch 2 0 0 3 ``BIOS_FUNC_1_RETURN
